...
func CreateTask(ctx context.Context, projectID string, req models.CreateTaskRequest) (*models.Task, error) {
...
func UpdateTask(ctx context.Context, taskID string, req models.UpdateTaskRequest) (*models.Task, error) {
	...
	_, err = database.ExecWithTimeout(ctx, db, query, args...)
	if err != nil {
...
func ListTasks(ctx context.Context, projectID string, req models.ListTasksRequest) (*models.ListTasksResponse, error) {
	...
	var total int
	row := database.QueryRowWithTimeout(ctx, db, countQuery, args...)
