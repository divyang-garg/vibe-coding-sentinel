...
// Provides centralized functions for accessing shared entities across modules
...
func GetChangeRequestByID(ctx context.Context, changeRequestID string) (*ChangeRequest, error) {
	...
	row := queryRowWithTimeout(ctx, query, changeRequestID)
...
func GetKnowledgeItemByID(ctx context.Context, knowledgeItemID string) (*KnowledgeItem, error) {
...
func GetComprehensiveValidationByID(ctx context.Context, validationID string) (*ComprehensiveValidation, error) {
	query := `
	...
	row := queryRowWithTimeout(ctx, query, validationID)
...
func GetTestRequirementByID(ctx context.Context, testRequirementID string) (*TestRequirement, error) {
...
func ValidateTaskLink(ctx context.Context, linkType string, linkedID string) error {
	if err := ValidateUUID(linkedID); err != nil {
		...
		if linkType == LinkTypeComprehensiveAnalysis {
			...
			row := queryRowWithTimeout(ctx, query, linkedID)
			var exists bool
