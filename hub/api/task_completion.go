// Phase 14E: Auto-Completion & Alert System
// Automatically marks completed tasks and alerts on incomplete critical tasks
...
func ArchiveTask(ctx context.Context, taskID string) error {
	...
	_, err = execWithTimeout(ctx, query, now, now, taskID)
	if err != nil {
