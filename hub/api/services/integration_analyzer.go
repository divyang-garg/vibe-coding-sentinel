...
func analyzeIntegrationLayer(ctx context.Context, feature *DiscoveredFeature) ([]IntegrationLayerFinding, error) {
	...
	// Note: DiscoveredFeature doesn't have Context field - removed this check for now
	// Would need codebasePath parameter or feature metadata to validate contracts
	// Contract validation disabled until Context field is available
